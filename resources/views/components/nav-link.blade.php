...
@php
    $classes = ($active ?? false)
        ? 'flex items-center px-4 py-2 w-full text-sm font-medium text-gray-900 bg-indigo-100 rounded-md focus:outline-none  focus:bg-gray-200 transition duration-150 ease-in-out'
